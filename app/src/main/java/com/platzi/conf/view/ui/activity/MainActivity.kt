package com.platzi.conf.view.ui.activity
...
//                "                'category' : 6,\n" +
//                "                'image' : 'https://pbs.twimg.com/profile_images/1165056572990644224/IyXE0l_c_400x400.jpg',\n" +
...
//                "                'category' : 13,\n" +
//                "                'image' : 'https://pbs.twimg.com/profile_images/1217289252645502977/zt1KiX4r_400x400.jpg',\n" +
//                "                'jobtitle' : 'Periodista',\n" +
...
//            val currentObject = jsonArr.get(i) as JSONObject
//            var speaker = Speaker(
//                currentObject.getString("name"),
//                currentObject.getString("jobtitle"),
//                currentObject.getString("biography"),
//                currentObject.getString("workplace"),
//                currentObject.getString("twitter"),
//                currentObject.getString("image"),
//                currentObject.getInt("category")
//                )
//            firebaseFirestore.collection("speakers").document().set(speaker);
//        }
//
//        for(i in 0 until jsonArr2.length()){
//            val currentObject = jsonArr2.get(i) as JSONObject
//            var calendar = Calendar.getInstance()
//            calendar.timeInMillis = currentObject.getLong("datetime") * 1000
//            var conference = Conference(
//                currentObject.getString("title"),
//                currentObject.getString("description"),
//                currentObject.getString("tag"),
//                calendar.time,
//                currentObject.getString("speaker")
//                )
//
//
